...
#     user = models.OneToOneField(User, on_delete=models.CASCADE)
#     profile_photo = models.ImageField(upload_to='driver/static/profile-photos/', blank=True, null=True)
#     phone_number = models.CharField(max_length=50, blank=True)
...
#     taxi_passenger = models.ForeignKey(Passenger, on_delete=models.CASCADE, null=False)
#     taxi_passenger_phone_number = models.CharField(max_length=50, default='')
#     taxi_passenger_payment_method = models.CharField(max_length=50, default='')
#     taxi_driver = models.ForeignKey(Driver, on_delete=models.SET_NULL, null=True, blank=True)
