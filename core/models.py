...
class Passenger(models.Model):
    passenger = models.OneToOneField(User , on_delete=models.CASCADE, default=None)
...
class Taxi (models.Model):
    ...
    taxi_passenger = models.ForeignKey(Passenger, on_delete=models.CASCADE, default=None)
    ...
    taxi_status = models.CharField(max_length=100, choices=STATUSES, default=BOOKING_IN_PROGRESS)
