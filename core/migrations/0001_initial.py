# Generated by Django 4.2.1 on 2023-06-20 04:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepted_trips', models.ManyToManyField(blank=True, related_name='accepted_drivers', to='core.taxi')),
                ('cancelled_trips', models.ManyToManyField(blank=True, related_name='cancelled_drivers', to='core.taxi')),
                ('completed_trips', models.ManyToManyField(blank=True, related_name='completed_drivers', to='core.taxi')),
                ('current_trips', models.ManyToManyField(blank=True, related_name='current_drivers', to='core.taxi')),
        ...
        migrations.CreateModel(
            ...
            bases=('core.user',),
            managers=[
                ('passenger', django.db.models.manager.Manager()),
                ('objects', django.contrib.auth.models.UserManager()),
            ],
        ),
    ]
